...
public class SFEnemy {
    ...
    public void applyDamage() {
        ...
        switch(enemyType) {
            case SFEngine.TYPE_INTERCEPTOR:
                if(damage == SFEngine.INTERCEPTORS_SHIELDS) {
                    isDestroyed = true;
                }
                break;
    ...
    public float getNextScoutY() {
        return (SFEngine.BEZIER_Y_1 * (posT * posT * posT)) +
