...
/**
 * Created by Tomek on 2016-08-25.
 */
public class SFEngine {
    ...
    public static final int SPLASH_SCREEN_MUSIC = R.raw.pigs;
    ...
    public static int CHARACTER_SHEET = R.drawable.starshipsheet;
    ...
    public static final int WEAPONS_SHEET = R.drawable.boombam;
    public static final int PLAYER_SHIELDS = 5;
    public static final int SCOUT_SHIELDS = 3;
    public static final int INTERCEPTORS_SHIELDS = 1;
